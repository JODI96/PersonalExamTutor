...
def new_week(n: int) -> None:
    ...
    dirs = [
        ...
        ROOT / "pdfs" / f"week_{wn}" / "vorlesung",
        ROOT / "pdfs" / f"week_{wn}" / "uebungen",
        ROOT / "pdfs" / f"week_{wn}" / "loesungen",
    ...
    print(f"OK Created pdfs/week_{wn}/vorlesung|uebungen|loesungen")
    print()
