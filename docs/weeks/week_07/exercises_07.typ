// Echte Kursübungen — Woche 7 (konvertiert am 2026-05-09)
// Quelle: README.adoc
...
=== Aufgabe 1 — Data Integration: ETL mit OpenRefine

Lösen Sie das OpenSchoolMaps-Arbeitsblatt „Daten sichten, bereinigen und integrieren mit OpenRefine".

Sie finden dieses auf #link("https://openschoolmaps.ch") unter #link("https://openschoolmaps.ch/pages/materialien.html")[Unterrichtsmaterialien] im Abschnitt „Weitere Informatik-Themen und -Werkzeuge". (#link("https://openschoolmaps.ch/pages/materialien.html#daten-sichten-bereinigen-und-integrieren-mit-openrefine")[Direkt-Link] in den Abschnitt)
